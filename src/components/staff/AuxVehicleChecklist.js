...
export default function AuxVehicleChecklist({ journeyId, userId, onComplete, preview = false, missionInfo, onRefresh }) {
        ...
        try {
            ...
            await supabase.from('staff_events')
                .insert({
                    ...
                    payload: { role: 'assistant', source: 'auto_start_after_load' }
                });
