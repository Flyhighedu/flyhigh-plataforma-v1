...
export default function EscuelasGalleryV2() {
    // A/B TEST V2: Framer Motion + Spring Physics Engine
    ...
    return (
        <section ref={containerRef} className="relative w-full overflow-hidden z-20 border-b-8 border-yellow-400 bg-slate-50" style={{ contain: 'layout paint' }}>

            {/* TEST MODE INDICATOR */}
            <div className="absolute top-0 left-0 w-full bg-yellow-400 text-black text-center text-xs font-bold py-1 z-50 animate-pulse">
                MODO TEST: VERSIÓN V2 (Framer Motion + Springs)
            </div>
