...
import FloatingTrailerBtn from './FloatingTrailerBtn';
...
export default function Hero() {
    ...
    return (
        <>
            ...
            <div className="h-[100svh] w-full bg-white text-[#1D1D1F] font-sans overflow-hidden flex flex-col relative selection:bg-black selection:text-white pt-16 sticky top-0 z-0" style={{ willChange: 'transform' }}>
         ...
         ===================================================================================== */}
                ...
                >
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none z-20 pt-4 md:pt-12">
                        <motion.div
                            className="relative w-20 h-20 flex items-center justify-center group pointer-events-auto cursor-pointer"
                            onClick={openModal}
                        ...
                        >
                            ...
                            {/* ANILLO PULSANTE EXTERIOR (Invita a presionar) */}
                            <motion.div
                                className="absolute inset-[-6px] rounded-full bg-white/5 border border-white/10"
                                animate={{
                                    scale: [1, 1.15, 1],
                                    opacity: [0.5, 0, 0.5]
                                }}
                            ...
                            {/* SEGUNDO ANILLO PULSANTE (Desfasado para efecto cascada) */}
                            <motion.div
                                className="absolute inset-[-3px] rounded-full bg-white/10 border border-white/15"
                                animate={{
                                    scale: [1, 1.1, 1],
                                    opacity: [0.7, 0.2, 0.7]
                                }}
                            ...
                            {/* ANILLO DE CONTENCIÓN (Glow blanco sutil) */}
                            <div className="absolute inset-0 rounded-full bg-white/15 backdrop-blur-sm ring-2 ring-white/30 shadow-[0_0_20px_rgba(255,255,255,0.15)]" />

                            {/* CASCO DE CRISTAL (Pure Transparent Hull) */}
                            <div className="absolute inset-[2px] rounded-full bg-white/5 backdrop-blur-[2px] border border-white/30 flex items-center justify-center shadow-[0_0_20px_rgba(255,255,255,0.1),inset_0_0_15px_rgba(255,255,255,0.1)] transition-all duration-300 group-hover:bg-white/10 group-hover:shadow-[0_0_30px_rgba(255,255,255,0.2)]">
                                {/* Icono PLAY (Blanco Puro) */}
         ...
         ===================================================================================== */}
            ...
            {/* FLOATING TRAILER BUTTON - Aparece cuando el Hero sale del viewport */}
            <FloatingTrailerBtn />
        </>
    );
};
